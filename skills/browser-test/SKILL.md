...
```javascript
mcp_snapshot -
  query_find_by_name((file_path = "snapshot.log"), (name = "搜索"));
mcp_snapshot -
  query_find_by_role((file_path = "snapshot.log"), (role = "button"));
mcp_snapshot -
  query_find_by_text((file_path = "snapshot.log"), (text = "登录"));
mcp_snapshot -
  query_find_by_regex(
...
mcp_snapshot -
  query_get_element_path((file_path = "snapshot.log"), (ref = "ref-xxx"));
...
const result =
  mcp_snapshot -
  query_find_by_name((file_path = "snapshot.log"), (name = "Login"));
...
mcp_fast -
  paddleocr -
  mcp_ocr_image((image_path = "webpage.png"), (language = "ch"));
